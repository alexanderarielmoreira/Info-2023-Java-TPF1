...
public class DatosDeClientesBancarios {
    ...
    public void cargarDatos() {
        ...
        // Asignación de cuentas a cliente;
        ...
        // Se agregan clientes a la bd;
        BdClientes.setBdCliente(cliente1);
        BdClientes.setBdCliente(cliente2);
        BdClientes.setBdCliente(cliente3);
        BdClientes.setBdCliente(cliente4);
        BdClientes.setBdCliente(cliente5);
        BdClientes.setBdCliente(cliente6);
        BdClientes.setBdCliente(cliente7);
        BdClientes.setBdCliente(cliente8);
        BdClientes.setBdCliente(cliente9);
        BdClientes.setBdCliente(cliente10);

        //////////////////////////////////////////////////////////////
        // Recorre y muestra la lista de clientes;

        for ( Cliente cliente : BdClientes.getBdClientesBancarios()) {
            System.out.println(
                            "Cliente: " + cliente.getNombre().toUpperCase() + " | " + "ID: " + cliente.getId() + " | " +
                            "Domicilio: " + cliente.getDomicilio() + " | "
            );
            for ( Cuenta cuenta: cliente.getCuentas()) {
                System.out.println(
                        "Cuenta N° " + cuenta.getId() + " | " +
